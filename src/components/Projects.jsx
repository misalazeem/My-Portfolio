...
import SWimage from '../images/spendwise.jpg';
  ...
  const Projects = [
    {
      ...
      name: 'SpendWise',
      stack: ['Ruby on Rails'],
      summary: 'This is a Budget app built on ruby on rails. This is a full stack app which features login/signup of users who can add categories and transactions to track their spendings.',
      image: SWimage,
      year: '2023',
      type: 'Full Stack Dev',
      github: 'https://github.com/misalazeem/Budget-App',
      livedemo: 'https://spendwise-sqra.onrender.com/',
    },
